...
(function ( $ ) {
	...
	function GetLang( sets ) {
		var l = [];
		if ( sets.indexOf( 'html' ) !== -1 ) {
			l.push( HTMLArr );
		}
		if ( sets.indexOf( 'js' ) !== -1 ) {
			l.push( JSArr );
		}
		if ( sets.indexOf( 'css' ) !== -1 ) {
			l.push( CSSArr );
		}
		if ( sets.indexOf( 'php' ) !== -1 ) {
			l.push( PHPArr );
		}
	...
	String.prototype.escapeHTML = function () {
		return(
				this.replace( />/g, '&gt;' ).replace( /</g, '&lt;' ).replace( /&lt;!--\?php/g, '&lt;?php' ).replace( /\?--&gt;/g, '?&gt;' )
				);
	};
						 ...
						 return this.each( function () {
							 if ( !$( this ).children( '.SRC_Wrap' ).length ) {
								 ...
								 if ( sets.lang ) {
									 ...
									 if ( sets.title ) {
										 Out.push( "<div class='SRC_Title'>" + sets.title + "</div>" );
									 }
