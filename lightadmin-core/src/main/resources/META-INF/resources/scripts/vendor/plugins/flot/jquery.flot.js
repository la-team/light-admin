	...
	function Plot( placeholder, data_, options_, plugins ) {
		...
		function insertLegend() {
			...
			for ( var i = 0; i < series.length; ++i ) {
				...
				fragments.push( '<td class="legendColorBox"><div style="' + options.legend.labelBoxBorderColor + '"><div style="width:15px;height:0;border:3px solid ' + s.color + ';overflow:hidden"></div></div></td>' + '<td class="legendLabel"><span>' + label + '</span></td>' );
			}
			if ( rowStarted ) {
				fragments.push( '</tr>' );
			}
