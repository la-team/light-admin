 ...
 */
public class FlexibleRepositoryRestController
   ...
   */
  protected DelegatingConversionService      conversionService                = new DelegatingConversionService(
      new DefaultFormattingConversionService()
  );
  protected MethodParameterConversionService methodParameterConversionService = new MethodParameterConversionService(
      conversionService
  );
  /**
  ...
  @SuppressWarnings({"unchecked"})
  protected void maybeAddPrevNextLink(URI resourceUri,
  ...
  @SuppressWarnings({"unchecked"})
  protected <V> V readIncoming(HttpInputMessage request, MediaType incomingMediaType, Class<V> targetType)
      throws IOException {
  ...
  @SuppressWarnings({"unchecked"})
  protected ResponseEntity<byte[]> errorResponse(ServletServerHttpRequest request, HttpStatus status, Throwable t)
      throws IOException {
    Object body = null;
  ...
  @SuppressWarnings({"unchecked"})
  protected ResponseEntity<byte[]> negotiateResponse(final ServletServerHttpRequest request,
  ...
  protected ResponseEntity<byte[]> maybeWrapJsonp(HttpStatus status,
                                                String jsonpParam,
