...
public class TransientFieldMetadataValidatorTest {
	...
	private void assertValidProperty( String property ) {
		assertTrue( testee.isValidFieldMetadata( transientFieldMetadata( property ), ParentClass.class ) );
	}

	private void assertInvalidProperty( String property ) {
		assertFalse( testee.isValidFieldMetadata( transientFieldMetadata( property ), ParentClass.class ) );
	}
