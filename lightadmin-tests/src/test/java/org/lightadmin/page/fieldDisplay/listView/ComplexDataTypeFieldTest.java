...
public class ComplexDataTypeFieldTest extends SeleniumIntegrationTest {
	...
	public void linkToAssociatedEntityWithoutAdministrationIsNotShown() {
		assertFalse( "Link to the associated entity without administration is displayed",
				webDriver().isElementPresent( webDriver().findElement( By.partialLinkText( "TestCustomer" ) ) ) );
	}

	private String[] expectedResult2 = { "2", "Order2: no line items", "TestCustomer #10", "" };

	private String[] expectedResult1 = { "1", "Order1: 100 line items", "TestCustomer #10", "LineItem Id: 1; Product Name: Product 1\n" +
