...
<c:set var="hrefTemplate"><light:domain-type-href-template domainType="${attributeMetadata.type}"/></c:set>
<div class="floatleft">
	<select name="${attributeMetadata.name}" id="${attributeMetadata.name}" hrefTemplate="${hrefTemplate}" style="opacity: 0; ">
