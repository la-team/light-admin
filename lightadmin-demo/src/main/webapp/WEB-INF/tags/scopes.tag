...
<%@ tag import="org.lightadmin.core.view.support.Scope" %>

<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
<%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>

<%@ attribute name="scopes" required="true" rtexprvalue="true" type="org.lightadmin.core.view.support.Scopes"%>

<c:set var="tag_scopes_scopeList" value="<%= Iterables.toArray( scopes, Scope.class ) %>"/>
